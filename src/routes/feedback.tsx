          ...
          {feedbacks.map((feed) => (
            ...
            >
              <AccordionTrigger
                ...
                className={cn(
                  "px-5 py-3 flex items-center justify-between text-base rounded-t-lg transition-colors hover:no-underline text-white",
                  activeFeed === feed.id ? "text-white" : "hover:bg-white"
                )}
              >
