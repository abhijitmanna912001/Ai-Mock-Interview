    ...
    <div className="flex-col w-full pb-24">
      <Container>
        ...
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[420px] drop-shadow-md overflow-hidden relative">
          ...
          <div className="absolute top-4 left-4 px-4 py-2 rounded-md bg-white/80 backdrop-blur-md">
            Inteviews Copilot&copy;
          </div>

          <div className="hidden md:block absolute w-80 bottom-4 right-4 px-4 py-2 rounded-md bg-white/80 backdrop-blur-md">
